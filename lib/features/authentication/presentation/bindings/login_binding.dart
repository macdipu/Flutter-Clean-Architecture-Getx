...
import 'package:clean_architecture_getx/features/authentication/domain/use_case/auth_use_case.dart';
...
class LoginBinding extends Bindings {
  ...
  void dependencies() {
    ...
    // Put AuthUseCase if need cache then use AuthCacheImpl else direct use AuthHttpImpl
    Get.lazyPut<AuthUseCase>(() => AuthUseCase(Get.find<AuthRepository>()), fenix: true);
